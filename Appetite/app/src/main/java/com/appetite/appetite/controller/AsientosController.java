 ...
 */
public class AsientosController extends AsyncTask<String, String, String> {
    ...
    public AsientosController (Activity activity, String time, String date, String time2){
